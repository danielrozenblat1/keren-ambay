...
import logo from "../../images/קרן אמבאי לוגו.png"
...
const NavBarNew = () => {
  ...
  const handleClick = () => {
    const phoneNumber = "+972538622224";
    const message = "היי קרן ,אני רוצה לשמוע ממך עוד על..";
  ...
  return (
    <nav className={`${styles.navbar} ${isSticky ? styles.sticky : ''}`}>
      ...
      <div className={styles.socialIcons}>
        <a href="https://www.instagram.com/keren_ambay_hair/" target="_blank" rel="noopener noreferrer"><FaInstagram /></a>
